  ...
  return (
    ...
    <form onSubmit={(e)=> handleSubmit(e)} style={{ width: "100%", height: "70px", backgroundColor: "#42e29dff", display: "flex", alignItems: "center", justifyContent: "space-evenly" }}>
      ...
      <nav style={{display: "flex", width: "350px", justifyContent: "space-evenly"}}>
                ...
                <NavLink activeStyle={{color: "#947abf"}} style={{ textDecoration: "none",  fontWeight: "800", color: "#6c42aeff" , border: "solid 2px grey", borderRadius: "10px"}} to="/ChefMenu">Home</NavLink>
                
                
                <NavLink activeStyle={{color: "#947abf"}} style={{ textDecoration: "none",  fontWeight: "800", color: "#6c42aeff", border: "solid 2px grey", borderRadius: "10px"}} to="/ChefProfile">Profile</NavLink>
